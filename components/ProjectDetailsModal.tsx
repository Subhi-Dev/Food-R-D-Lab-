            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <span
                    className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${getStatusStyle(project.status)}`}
                  >
                    {project.status}
                  </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <div className="px-4 py-2 bg-gray-50 dark:bg-slate-900/50 rounded-2xl flex items-center gap-2">
                      <span className="text-xs font-bold uppercase text-gray-400 dark:text-slate-500">
                        Category
                      </span>
              ...
              <div className="bg-[#E0F2FE] dark:bg-sky-900/20 rounded-[2.5rem] p-8 flex flex-col justify-between border border-sky-100 dark:border-sky-800/30">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-sky-900 dark:text-sky-100 mb-1">
                    Processing
                  </h3>
                  <p className="text-sky-700/70 dark:text-sky-200/60 text-sm">
                ...
                <div className="space-y-3 mt-6">
                  <div className="flex justify-between items-center bg-white/40 dark:bg-sky-950/40 p-3 rounded-2xl">
                    <span className="text-xs font-bold text-sky-800 dark:text-sky-200 uppercase">
                      Temp
                    </span>
                    <span className="text-xl font-bold text-sky-900 dark:text-slate-100">
              ...
              <div className="bg-white dark:bg-[#1e293b] rounded-[2.5rem] p-8 border border-gray-100 dark:border-slate-800 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto pr-2 space-y-3 max-h-[200px] scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-slate-700">
                  {project.ingredients.map((ing, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center p-3 bg-gray-50 dark:bg-slate-900/50 rounded-2xl"
                    >
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-3 bg-white dark:bg-[#1e293b] rounded-[2.5rem] p-8 border border-gray-100 dark:border-slate-800">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {project.recentLabResults &&
                  project.recentLabResults.length > 0 ? (
                    project.recentLabResults.map((res, idx) => (
                      <div
                        key={idx}
                        className="group bg-gray-50 dark:bg-slate-900/50 p-5 rounded-[2rem] hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg dark:hover:shadow-black/20 hover:border-transparent border border-gray-100 dark:border-slate-700 transition-all"
                      >
                        ...
                        <div
                          className={`mt-3 inline-block px-3 py-1 rounded-lg text-xs font-bold uppercase ${
                            res.status === 'pass'
